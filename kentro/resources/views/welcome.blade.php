            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <!-- <li class="nav-item"><button class="btn btn-success">
                        <a class="nav-link text-white" href="{{route('form.view')}}">Register</a>
                    </button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 carrot-grid">
                            <div class="product-card">
                                ...
                                <h4>Carrot</h4>
                                <p>by Supplier</p>
                                <div class="product-price">Rs. 65 / kg</div>
                                <p>Posted on: Aug 08, 2024</p>
                                <p>Posted quantity: 100kg</p>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 leaks-grid">
                            <div class="product-card">
                                <div class="d-flex justify-content-start align-items-center">
                                    <span class="badge badge-fresh">Fresh</span>
                                    <span class="badge badge-new ml-2">New</span>
                                </div>
                                <img src="{{ asset('build/assets/image/leaks.jpg') }}" alt="Product">
                                <h4>Leaks</h4>
                                <p>by Supplier</p>
                                <div class="product-price">Rs. 75 / kg</div>
                                <p>Posted on: Aug 08, 2024</p>
                                <p>Posted quantity: 200kg</p>
                                <div class="d-flex justify-content-between">
                                    <button class="order-button">
                                        <i class="bi bi-cart"></i> Place Order
                                    </button>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 carbbage-grid">
                            <div class="product-card">
                                <div class="d-flex justify-content-start align-items-center">
                                    <span class="badge badge-fresh">Fresh</span>
                                    <span class="badge badge-new ml-2">New</span>
                                </div>
                                <img src="{{ asset('build/assets/image/cabbage.png') }}"alt="Product">
                                <h4>Carbbage</h4>
                                <p>by Supplier</p>
                                <div class="product-price">Rs. 75 / kg</div>
                                <p>Posted on: Aug 08, 2024</p>
